...
var redGhostImg
var yellowGhostImg
var pacman , pacImg , pacIdle
var pacUp , pacDown , pacLeft , pacRight
...
function preload(){
  ...
  yellowGhostImg = loadImage("images/YELLOW.png");
  pacUp = loadAnimation("images/UpOpen.png","images/UpClosed.png");
  pacIdle = loadImage("images/RightOpen.png");
...
function setup(){
  ...
  var pacman = createSprite(583 , 281,20,20);
   pacman.addImage(pacIdle);
...
function draw(){
  ...
  ghosts();
  if(keyDown(UP_ARROW)){
    pacman.changeAnimation("UP",pacUp)
    pacman.velocityX = 0
    pacman.velocityY = -2
  }
...
function ghosts(){
   ...
   var greenGhost = createSprite(265,290,30,30);
   greenGhost.addImage(greenGhostIMG);
   greenGhost.scale = 0.06


  var redGhost = createSprite(886,485,30,30);
  redGhost.addImage(redghostImg);
  redGhost.scale = 0.06

  var yellowGhost = createSprite(499,159,30,30);
  yellowGhost.addImage(yellowGhostImg);
  yellowGhost.scale = 0.02
